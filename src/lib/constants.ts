...
export const TEAM = [
  {
    ...
    icon: "ClipboardList" as const,
    bio: "Layla coordinates field operations and project timelines across active residential and commercial jobs. She works closely with subcontractors, clients, and the VVH leadership team to keep every phase of a project organized and on schedule.",
  },
  {
    name: "Sanaan Mazhar",
